...
<head>
    ...
    <title>{{ config('app.name', 'Forum Sample') }}</title>
...
<style>
    ...
    nav{z-index:99;}
    .user-info a{color: #999292 !important;}
</style>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    {{ config('app.name', 'Forum Sample') }}
                </a>
                <a class="navbar-brand" href="{{route('threads')}}"> Discusses
                </a>
